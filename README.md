...
| 版本 | 特性 |
| --- | --- |
| **0.8.0-rc.1**（当前，Latest） | 内核大版本升级 **dsh 0.1.5-rc.1**：会话格式 V3（⚠️ 不支持降级读取）、`DeepSeek-V41-Flash` 新模型、右侧 Sidebar 重构、任意类型文件上传、可继续子代理排队/Steer；「软件信息」支持**检查更新 / 一键升级 / 回退**（流式下载 + 进度条）；壳代码无变化 |
